...
<body>
	...
	<div align="center">
		<img src="photos/pp.png" height="10%" width="10%"
			style="border-radius: 25px;">
	</div>
	<center>
		<div class="login">
			<center id="fcolor4">
				<b style="font-size: x-large; color: black"> Please enter your
					login details to process </b> <br>
				<br>
				<br>
				<br>
				<form name="login" action="LoginHandler" method="post">
					<table border="0">
						<thead>
							<tr>
								<th style="color: black">USERNAME: <input type="text"
									name="uName" value="" id="textbox" /><br />
								<br />
								</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<th style="color: black">PASSWORD: <input type="password"
									name="uPassword" value="" id="textbox" /><br />
								<br />
								</th>
							</tr>
							<tr>
                         ...
                         %>
							...
							<tr>
								<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
									type="submit" value="LOGIN" id="buttoncolor" /> <br />
								<br /></td>
