...
<div class="log">
   ...
   <form action="../LogoutHandler" method="get">
     ...
     <form action="../DoctorPwdResetHandler" method="post" name="repa" onsubmit="return formValidateReg();" >
     	<table>
     		<tr><td style='color:white;font-size:x-large;'></td><td><input type="hidden" value="<% out.print(name);%>" name="id" id="textbox" ></td></tr>
			
			<tr><td style='color:white;font-size:x-large;'> your mail</td><td style='color:white;font-size:x-large;'><% out.print(ad);%></td></tr>
			 <tr><td style='color:white;font-size:x-large;'>Doctor id</td><td><input type="password" name="old" id="textbox"></td></tr>
...
var name = document.forms["repa"]["old"].value;
